...
const VertPaths : React.FC<Prop> = ({color, rotate = false, startCountFrom, pots, isPlayerTurn}):React.JSX.Element => {


  const colorPath = [4, 5, 7, 10, 13, 16];

  return (
    <div style={{ rotate: rotate ? "180deg" : ""}} className='vert_path_container'>
